...
DisplayInventory::~DisplayInventory() {}
// get customer ID
int DisplayInventory::getCustomerID() { return 0; }
// virtual create method
Transaction *DisplayInventory::create() const { return new DisplayInventory; }
// virtual set data method
bool DisplayInventory::setData(istream &) { return true; }
